...
import imgPause from "../../assets/slider/pause.png"
...
{/* arrows */}
            <ArrowLeftOutlinedIcon className="arrow prev" id="prev" onClick={(e)=>currentSlide(e)}/>
            <ArrowRightOutlinedIcon className="arrow next" id="next" onClick={(e)=>currentSlide(e)}/>   
        {
